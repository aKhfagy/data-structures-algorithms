...
int main() {
    ...
    map<char, vector<int> > occ_count_before = {
        ...
        {'A', vector<int>(bwt.size() + 1)},
        {'C', vector<int>(bwt.size() + 1)},
        {'G', vector<int>(bwt.size() + 1)},
        {'T', vector<int>(bwt.size() + 1)}
    };
